...
现在你需要根据用户提供的「类别」「关键词」「风格偏好」，为用户生成 3 个候选名字（精简极速版）。
  ...
  "names": [
    {
      ...
      "meaning": "寓意解析1（简洁、自然的中文描述，全句不超过 20 个汉字）",
      "source": "灵感来源（例如诗词 / 自然意象 / 品牌调性等，全句不超过 10 个汉字）"
    },
    {
      "name": "名字2",
      "pinyin": "拼音2（使用标准汉语拼音，小写，音节之间用空格分隔）",
      "meaning": "寓意解析2（简洁、自然的中文描述，全句不超过 20 个汉字）",
      "source": "灵感来源（例如诗词 / 自然意象 / 品牌调性等，全句不超过 10 个汉字）"
    },
    {
      "name": "名字3",
      "pinyin": "拼音3（使用标准汉语拼音，小写，音节之间用空格分隔）",
      "meaning": "寓意解析3（简洁、自然的中文描述，全句不超过 20 个汉字）",
      "source": "灵感来源（例如诗词 / 自然意象 / 品牌调性等，全句不超过 10 个汉字）"
    }
  ]
}
